...
import { ExternalLink, Loader2, ClipboardList, ArrowLeft } from 'lucide-react';
...
export default function ExamsPage() {
  ...
  useEffect(() => {
    fetch('/api/admin/exams')
      .then(res => res.json())
      .then(data => {
        setExams(Array.isArray(data) ? data.filter((e: Exam) => e.isActive) : []);
      })
      .catch(console.error)
        ...
        <Container>
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-white/80 mt-2">Access your exams and assessments online</p>
            </div>
          </div>
        </Container>
      </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {exams.map((exam, index) => (
                <a
                  ...
                  className="group bg-white rounded-2xl p-6 shadow-sm border hover:shadow-xl hover:border-purple-500/30 transition-all duration-300"
                >
