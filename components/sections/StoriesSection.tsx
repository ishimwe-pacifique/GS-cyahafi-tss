...
const stories: Story[] = [
  {
    ...
    excerpt: 'Meet John, a BDC graduate who now leads construction projects across Kigali. His journey from classroom to successful career...',
    fullStory: "John joined GS Cyahafi TSS with a passion for building. Through our Building Construction (BDC) program, he mastered technical drawing, masonry, and project management. Today, John is a site manager for a major firm in Kigali, proving that technical education is a direct path to national development and personal success.",
    date: 'April 10, 2026',
    category: 'Alumni Success',
    image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/gs%20image2-GBAlBSIn3OZOriyfBaQUotKE7L5dnQ.jpeg', 
  },
  {
    id: 2,
    title: 'New Laboratory Facilities Completed',
    excerpt: 'We are proud to announce the completion of our new modern classrooms and technical facilities. This expansion ensures...',
    fullStory: "Our commitment to quality education continues with the inauguration of a new technical block. This facility includes advanced computer labs and specialized workshops. GS Cyahafi TSS can now accommodate more students, providing them with modern tools for 21st-century learning.",
    date: 'March 15, 2026',
  ...
  },
  {
    ...
    excerpt: 'Our Food and Beverage Operations students showcased culinary excellence at the national competition, earning top honors...',
    fullStory: "Our culinary stars have done it again! Students from the Food and Beverage Operations (FBO) department took home the Gold Medal at the Regional TVET Skills Competition. They impressed judges with their professional service techniques.",
